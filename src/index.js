...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Book', 'model/Books', 'model/Bookshelf', 'model/BookshelfBookshelf', 'model/Bookshelfs', 'model/BookshelfsBookshelfs', 'model/Review', 'model/Reviews', 'model/Token', 'model/User', 'api/BookApi', 'api/ReviewApi', 'api/TokenApi', 'api/UserApi', 'api/UserBookshelfApi'], factory);
...
}(function(ApiClient, Book, Books, Bookshelf, BookshelfBookshelf, Bookshelfs, BookshelfsBookshelfs, Review, Reviews, Token, User, BookApi, ReviewApi, TokenApi, UserApi, UserBookshelfApi) {
  'use strict';
