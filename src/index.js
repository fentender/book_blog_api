...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Book', 'model/Books', 'model/Bookshelf', 'model/BookshelfInner', 'model/Bookshelfs', 'model/BookshelfsInner', 'model/Review', 'model/Reviews', 'model/User', 'api/BookApi', 'api/ReviewApi', 'api/UserApi', 'api/UserBookshelfApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Book'), require('./model/Books'), require('./model/Bookshelf'), require('./model/BookshelfInner'), require('./model/Bookshelfs'), require('./model/BookshelfsInner'), require('./model/Review'), require('./model/Reviews'), require('./model/User'), require('./api/BookApi'), require('./api/ReviewApi'), require('./api/UserApi'), require('./api/UserBookshelfApi'));
  }
}(function(ApiClient, Book, Books, Bookshelf, BookshelfInner, Bookshelfs, BookshelfsInner, Review, Reviews, User, BookApi, ReviewApi, UserApi, UserBookshelfApi) {
  'use strict';
  ...
  var exports = {
    ...
    Bookshelf: Bookshelf,
    /**
     * The BookshelfInner model constructor.
     * @property {module:model/BookshelfInner}
     */
    ...
    /**
     * The BookshelfsInner model constructor.
     * @property {module:model/BookshelfsInner}
     */
    BookshelfsInner: BookshelfsInner,
    /**
