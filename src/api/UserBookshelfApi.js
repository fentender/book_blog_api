...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Bookshelf', 'model/BookshelfInfo', 'model/Bookshelfs'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Bookshelf'), require('../model/BookshelfInfo'), require('../model/Bookshelfs'));
  } else {
    // Browser globals (root is window)
    if (!root.BookBlogApi) {
      root.BookBlogApi = {};
    }
    root.BookBlogApi.UserBookshelfApi = factory(root.BookBlogApi.ApiClient, root.BookBlogApi.Bookshelf, root.BookBlogApi.BookshelfInfo, root.BookBlogApi.Bookshelfs);
  }
}(this, function(ApiClient, Bookshelf, BookshelfInfo, Bookshelfs) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} username User's ID
     * @param {module:model/BookshelfInfo} bookshelf Info of bookshelf
