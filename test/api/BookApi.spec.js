    ...
    describe('BookApi', function() {
      describe('createBook', function() {
        it('should call createBook successfully', function(done) {
          // TODO: uncomment, update parameter values for createBook call
          /*
          var book = new BookBlogApi.Book();
          book.bookId = 0;
          book.bookName = "";
          book.autor = "";
          book.info = "";

          instance.createBook(book, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateBook', function() {
        it('should call updateBook successfully', function(done) {
          ...
          instance.updateBook(bookId, book, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
